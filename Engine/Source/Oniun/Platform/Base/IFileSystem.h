...
namespace Onu
{
    struct IFileSystem
    {
        ...
        static bool CopyDirectory(const StringView& destPath, const StringView& srcPath, bool copySubDirectories = true) = delete;

        static bool DirectoryExists(const StringView& path) = delete;
        static bool GetDirectoryFiles(Array<String>& filePaths, const StringView& path, const StringView& searchPattern = TEXT("*"), DirectorySearch searchOpt = DirectorySearch_All) = delete;
