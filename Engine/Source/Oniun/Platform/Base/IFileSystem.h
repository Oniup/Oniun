...
namespace Oniun
{
    ...
    struct IFileSystem
    {
        ...
        static bool GetDirectoryFiles(Array<String>& filePaths, const StringView& path, const StringView& searchPattern, DirectorySearch searchOpt) = delete;
        ...
        static Array<String> OpenDialogMultiple(const StringView& openPath, const StringView& filter, const StringView& title = nullptr) = delete;
